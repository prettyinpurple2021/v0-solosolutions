...
export const brands: Brand[] = [
  {
    ...
    ctaUrl: "https://www.solosuccessai.fun",
    features: [
  ...
  },
  {
    ...
    icon: Film,
    ctaUrl: "https://www.solosuccesscontentfactory.digital",
    features: [
  ...
  },
  {
    ...
    icon: PenLine,
    ctaUrl: "https://www.soloscribe.buzz",
    features: [
